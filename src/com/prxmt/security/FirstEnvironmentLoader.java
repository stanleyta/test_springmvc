...
public class FirstEnvironmentLoader extends IniWebEnvironment {
    ...
    public static final String ENVIRONMENT_ATTRIBUTE_KEY = FirstEnvironmentLoader.class.getName() + ".ENVIRONMENT_ATTRIBUTE_KEY";
    private static final Logger log = LoggerFactory.getLogger(FirstEnvironmentLoader.class);
